"""
Command Line Interface for Rcri Lee Cardiac Risk.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="rcri-lee-cardiac-risk", description="Rcri Lee Cardiac Risk")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Rcri Lee Cardiac Risk Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Rcri Lee Cardiac Risk API server on http://{args.host}:{args.port}")
